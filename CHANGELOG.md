...
* build: add git installation to Dockerfile for development environment ([9587b87](https://github.com/f6ra07nk14/structcast/commit/9587b87))
* build: remove Node.js installation and dependencies from Dockerfile ([1969b6d](https://github.com/f6ra07nk14/structcast/commit/1969b6d))
* build: remove unsupported Python version 3.8 from the versions list ([71f177c](https://github.com/f6ra07nk14/structcast/commit/71f177c))
* build: upgrade dependency packages ([8060c26](https://github.com/f6ra07nk14/structcast/commit/8060c26))
* chore: update uv.lock to sync with pyproject.toml version ([cd00b27](https://github.com/f6ra07nk14/structcast/commit/cd00b27))
* chore(release): 1.1.0 [skip ci] ([bc51251](https://github.com/f6ra07nk14/structcast/commit/bc51251))
* ci: add job to publish wheel file to TestPyPI after successful release ([20ec1b9](https://github.com/f6ra07nk14/structcast/commit/20ec1b9))
* ci: add safe.directory configuration for GitHub Actions ([a13c5df](https://github.com/f6ra07nk14/structcast/commit/a13c5df))
* ci: change release type for CI changes to patch ([c401add](https://github.com/f6ra07nk14/structcast/commit/c401add))
* ci: enhance Docker image existence check with manifest details ([50bde38](https://github.com/f6ra07nk14/structcast/commit/50bde38))
* ci: prevent CI changes from triggering a release ([0368fe5](https://github.com/f6ra07nk14/structcast/commit/0368fe5))
* ci: publish job to deploy to PyPI instead of TestPyPI ([5980a96](https://github.com/f6ra07nk14/structcast/commit/5980a96))
* ci: refactor Docker image handling and remove unused cleanup job ([c981272](https://github.com/f6ra07nk14/structcast/commit/c981272))
* ci: remove redundant environment declaration from release job ([cdb5686](https://github.com/f6ra07nk14/structcast/commit/cdb5686))
* ci: restore conditions for publish-to-pypi job to ensure proper execution ([46661ce](https://github.com/f6ra07nk14/structcast/commit/46661ce))
* ci: simplify condition for publishing to TestPyPI ([b13b76c](https://github.com/f6ra07nk14/structcast/commit/b13b76c))
* ci: standardize environment name for TestPyPI job ([a2d6f99](https://github.com/f6ra07nk14/structcast/commit/a2d6f99))
* ci: update actions/checkout to v6 and remove package.json ([24d8d4b](https://github.com/f6ra07nk14/structcast/commit/24d8d4b))
* ci: update Docker image caching strategy and refine cleanup logic for merged PRs ([dcb7189](https://github.com/f6ra07nk14/structcast/commit/dcb7189))
* ci: update publish-to-pypi job conditions for better flexibility ([9e353ff](https://github.com/f6ra07nk14/structcast/commit/9e353ff))
* ci: update release job dependencies and permissions; add Node.js installation to Dockerfile ([7067276](https://github.com/f6ra07nk14/structcast/commit/7067276))
* ci: update release preparation command and include uv.lock in assets ([097d7f4](https://github.com/f6ra07nk14/structcast/commit/097d7f4))
* ci: update semantic-release setup to use actions/setup-node and install dependencies ([d3a8b48](https://github.com/f6ra07nk14/structcast/commit/d3a8b48))
* ci: update semantic-release setup to use cycjimmy/semantic-release-action and streamline configurati ([ea84682](https://github.com/f6ra07nk14/structcast/commit/ea84682))
* ci: use pre-installed semantic-release instead of npx (#10) ([ab86cc3](https://github.com/f6ra07nk14/structcast/commit/ab86cc3)), closes [#10](https://github.com/f6ra07nk14/structcast/issues/10)
* Fix semantic-release git detection failure in release job (#12) ([546dffa](https://github.com/f6ra07nk14/structcast/commit/546dffa)), closes [#12](https://github.com/f6ra07nk14/structcast/issues/12)
* Initial plan ([0371477](https://github.com/f6ra07nk14/structcast/commit/0371477))
* Merge branch 'main' into dev ([a1a7517](https://github.com/f6ra07nk14/structcast/commit/a1a7517))
* Merge branch 'refs/heads/main' into dev ([8447aae](https://github.com/f6ra07nk14/structcast/commit/8447aae))
* Merge pull request #11 from f6ra07nk14/dev ([edbd5d1](https://github.com/f6ra07nk14/structcast/commit/edbd5d1)), closes [#11](https://github.com/f6ra07nk14/structcast/issues/11)
* Merge pull request #13 from f6ra07nk14/dev ([cc65da3](https://github.com/f6ra07nk14/structcast/commit/cc65da3)), closes [#13](https://github.com/f6ra07nk14/structcast/issues/13)
* Merge pull request #6 from f6ra07nk14/copilot/fix-ci-errors-docker-push ([0ab0f36](https://github.com/f6ra07nk14/structcast/commit/0ab0f36)), closes [#6](https://github.com/f6ra07nk14/structcast/issues/6)
* Merge pull request #7 from f6ra07nk14/dev ([dca7a06](https://github.com/f6ra07nk14/structcast/commit/dca7a06)), closes [#7](https://github.com/f6ra07nk14/structcast/issues/7)
* Merge pull request #9 from f6ra07nk14/dev ([2a7e2ff](https://github.com/f6ra07nk14/structcast/commit/2a7e2ff)), closes [#9](https://github.com/f6ra07nk14/structcast/issues/9)
* Merge remote-tracking branch 'origin/dev' into dev ([262fff8](https://github.com/f6ra07nk14/structcast/commit/262fff8))
* Use docker manifest inspect instead of docker pull for image existence checks (#8) ([445896c](https://github.com/f6ra07nk14/structcast/commit/445896c)), closes [#8](https://github.com/f6ra07nk14/structcast/issues/8)
* refactor: remove redundant manifest information extraction from CI workflow ([0ecafcc](https://github.com/f6ra07nk14/structcast/commit/0ecafcc))
* style: add type ignore for validation in ObjectPattern ([64d5122](https://github.com/f6ra07nk14/structcast/commit/64d5122))
* feat: add custom pattern registration and validation tests ([dd24383](https://github.com/f6ra07nk14/structcast/commit/dd24383))
* docs: remove outdated usage guidelines and debugging tips from SKILL.md ([6cfab00](https://github.com/f6ra07nk14/structcast/commit/6cfab00))
* docs: update SKILL.md to enhance description and add usage examples ([48eff50](https://github.com/f6ra07nk14/structcast/commit/48eff50))
* fix: change Docker cache strategy to prevent untagged images ([6951228](https://github.com/f6ra07nk14/structcast/commit/6951228))
